...
#
#     #完事之后将pred_arr存起来
#     np.save(r"C:\Users\jchao\Desktop\calibrationDataset\jie\pred_arr", pred_arr)
#     print("over")
...
if __name__ == "__main__":
    ...
    for i in range(50):
        ...
        pred_x, pred_y = 108.19159821963717 * ret[0] + 1035.0231288336522, -109.31023422449694 * ret[1] + 109.91674963956888
        ...
        print("pred-> ", 108.19159821963717 * ret[0] + 1035.0231288336522,
              -109.31023422449694 * ret[1] + 109.91674963956888)
        print("real->", truth_arr[i])
