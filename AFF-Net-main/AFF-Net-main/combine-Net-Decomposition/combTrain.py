...
if __name__ == "__main__":
    data_path = r"C:\Users\jchao\Desktop\calibrationDataset\gagajie2"
    model_name = "jie2"
    save_path = r"C:\Users\jchao\Desktop\AFF-Net-main\AFF-Net-main\checkpoint2"
    ...
    # state_dict = torch.load("../checkpoint2/jicao.pt")
    state_dict = torch.load("../checkpoint2/Iter_20_jie2.pt")
    ...
    for epoch in range(1, all_epoch + 1):
        ...
        if epoch % save_step == 0:
            torch.save(net.state_dict(), os.path.join(save_path, f"Iter_{epoch + 20}_{model_name}.pt"))
